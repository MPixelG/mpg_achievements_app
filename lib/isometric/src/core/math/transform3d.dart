...
class Transform3D extends ChangeNotifier {
  ...
  Matrix4 get transformMatrix {
    ...
    if(!transformMatrix64Set) _transformMatrix64 = Matrix4.identity();
    if (_recalculate) {
      _transformMatrix64.setIdentity();
      _transformMatrix64.translateByVector3(Vector3(_position.x, _position.y, _position.z));
      _transformMatrix64.rotateZ(_angleRoll);
      _transformMatrix64.rotateY(_angleYaw);
      _transformMatrix64.rotateX(_anglePitch);
      _transformMatrix64.scaleByVector3(Vector3(_scale.x, _scale.y, _scale.z));
      _transformMatrix64.translateByVector3(Vector3(_offset.x, _offset.y, _offset.z));
      _recalculate = false;
    }
