...
class MenuBarButton extends StatelessWidget {
  ...
  const MenuBarButton({super.key, required this.child, required this.onPressed});
  ...
  Widget build(BuildContext context) => TextButton(
    ...
    style: ButtonStyle(
      ...
      padding: const WidgetStatePropertyAll(EdgeInsets.symmetric(horizontal: 4, vertical: 4)),
    ),
    child: child,
  );
}
