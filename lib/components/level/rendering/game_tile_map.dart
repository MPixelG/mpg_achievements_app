...
import '../isometric/isometricTiledComponent.dart';

class GameTileMap {

  late List<List<List<int>>> gids;
  ...
  Future<void> _addTileForGid(
    ...
    renderableTiles.add(RenderInstance(sprite.render, worldPos, tileZ, Vector2(tileX.toDouble(), tileY.toDouble()), RenderCategory.tile));
  }
