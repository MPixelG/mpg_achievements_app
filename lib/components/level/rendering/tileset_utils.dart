...
Tileset findTileset(int gid, Iterable<Tileset> tilesets) { //help function to find the correct tileset for a given gid
  ...
  for (final ts in tilesets) {// Iterate through all tilesets
