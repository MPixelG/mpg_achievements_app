...
class CollisionBlock extends PositionComponent with CollisionCallbacks{
  ...
  bool climbable;
  CollisionBlock({super.position, super.size, this.isPlatform = false, this.hasCollisionUp = true, this.hasCollisionDown = true, this.hasHorizontalCollision = true, this.climbable = false, this.isLadder = false});
