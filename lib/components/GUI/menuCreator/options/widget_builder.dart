...
import '../components/dependencyViewer/layout_widget.dart';
...
LayoutWidget addRow(LayoutWidget? parent, {Map<String, dynamic>? properties}) {
...
int positionedIndex =
    0; //this is used to give the positioned widgets a unique id
LayoutWidget? addPositioned(
  LayoutWidget? parent, {
  Map<String, dynamic>? properties,
}) {
  ...
  LayoutWidget widget = LayoutWidget(
    (context, children, properties) {
      ...
      return Image.asset(
        ...
        height: options.getValue("height", properties["height"]) * screenHeight,
...
int ninepatchButtonIndex =
    0; //this is used to give the nine patch button widgets a unique id
LayoutWidget addNinepatchButton(
  LayoutWidget? parent, {
  Map<String, dynamic>? properties,
}) {
  LayoutWidget widget = LayoutWidget(
...
LayoutWidget addInteractiveViewer(
  LayoutWidget? parent, {
  Map<String, dynamic>? properties,
}) {
  LayoutWidget widget = LayoutWidget(
...
LayoutWidget addSingleChildScrollView(
  LayoutWidget? parent, {
  Map<String, dynamic>? properties,
}) {
  LayoutWidget widget = LayoutWidget(
