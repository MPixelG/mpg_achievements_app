...
void registerWidgetOptions() {
  //this is used to register the widget options for the widgets that can be added to the layout

  if (WidgetOptions.isRegistered(Container)) {
    return; //if the widget options for the container are already registered, we return and do not register them again. this is to prevent duplicate registrations.
  }
  ...
  WidgetOptions(
    ...
    options: [
      ...
      WidgetOption<String>(
        ...
        options: {for (var value in loadedTextureNames) value: value},
      ),
    ],
  ).register();
