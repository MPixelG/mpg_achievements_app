...
class NodeViewerState extends State<NodeViewer> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.root == null) {
      //if there is no root widget, display a message
      return const Scaffold(
        body: Center(
          child: Text("No root widget defined"),
        ), // display that no root widget is defined
      );
    }
    ...
    return Scaffold(
      ...
      body: Container(
        //the actual body of the NodeViewer
        padding: const EdgeInsets.all(
          8,
        ), //padding around the content so that it doesnt touch the edges
  ...
  Widget _buildNodeContent(
    ...
    return Container(
      ...
      margin: const EdgeInsets.symmetric(
        vertical: 2.0,
      ), //with some vertical margin (the space between the nodes)
      padding: const EdgeInsets.all(
        8.0,
      ), //and some padding (the space inside the node)
      decoration: BoxDecoration(
        //the decoration of the container
        color: isHovering
        ...
        child: Column(
          ...
          children: [
            ...
            if (displayedChildren.isNotEmpty) ...[
              ...
              const SizedBox(
                height: 8,
              ), //a little space between the id and the children
              Padding(
