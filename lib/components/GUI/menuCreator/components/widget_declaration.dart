...
class WidgetDeclaration {
  ...
  LayoutWidget? Function(LayoutWidget? parent, {Map<String, dynamic>? properties}) builder;

  WidgetDeclaration(this.widgetType, this.id, this.displayName, this.icon, WidgetOptions options, this.builder){
    print("added");

    declarationCache.add(this);
  }
  @override
  int get hashCode => Object.hashAll([widgetType, id, displayName, icon, builder]);
      ...
      WidgetOptions(
        ...
        options: [
          ...
          WidgetOption<String>(
            ...
            options: {for (var value in NinePatchTexture.getLoadedTextureNames()) value: value},
          ),
        ],
      )..register(),
          (
      ...
      WidgetOptions(
        ...
        options: [
          WidgetOption<double>(
            ...
            name: "opacity",
            defaultValue: 0.5,
            description: "The opacity of the widget. If not set, 0.5 will be used.",
          ),
        ],
      )..register(),
          (
