...
ParticleSystemComponent generateConfetti(Vector2 pos, {int amount = 200}){
  ...
  Particle particle = Particle.generate(
    count: amount, //low-end/older devices like mine have problems with this amount of particles
    generator: (i) {
      ...
      return ComputedParticle(
        renderer: (unrotatedCanvas, _) {
          ...
          unrotatedCanvas.renderRotated(angle.toDouble(), position + pos, (canvas) {
